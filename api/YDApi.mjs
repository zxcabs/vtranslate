...
export default class YDApi {
    ...
    async getVideoFiles(dir) {
        const result = await this.diskResources({
            path: dir,
            limit: 250,
            fields: '_embedded.items.path,_embedded.items.name,_embedded.items.media_type,_embedded.items.public_url,',
        })
